#ifndef __CirDobleLinkList_H__
#define __CirDobleLinkList_H__
...
private:
    ...
    void internal_insert(const value_type &value, Ref ref){
        ...
        m_size++;
        //caso lista vacia, ambos punteros apuntan a si mismo
        if (!m_pRoot){
        ...
        //nuevo valor menor que el root, se deuvle la cabeza
        ...
        // buscar pos hasta encointrar el par act y follow donde insertar
        Node *act = m_pRoot;
        ...
        //punteros para insertar nuevo newnode entre act y follow
